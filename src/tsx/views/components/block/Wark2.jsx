          ...
          <div className="warks">
            ...
            <div className="test">
              <WarkContent
               ...
               detail = {<div> <p>選択した日付から1週間分の献立を保存しておくことが可能なメモアプリになります。</p>
               ...
               <p>改善点は多くありますが、評価の参考にしていただければ幸いです。</p></div>}
              />
              <WarkContent
               ...
               detail = {<div> <p>現在地の天気や気温、湿度などを調べることができる天気予報アプリになります。</p>
               <p>APIの使用方法を学ぶために作成しました。</p>
               <p>制作期間 2週間</p>
               <p>HTML/CSS JavaScript React OpenWeatherMapAPI</p>
               <p>OpenWeatherMapを用いてデータベース、ユーザー認証機能を実装。
               </p>
               <p>天気によってアイコンが変わる。</p></div>}
              />
              </div>
            </Scroll>
      </div>
